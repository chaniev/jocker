...
|------|--------|--------------------------|
| 0 (Baseline) | частично (baseline snapshot + A/B harness готовы) | прогнать `bot-compare` (`compare-v1`) и заполнить candidate-колонку/дельты в таблице `baseline vs candidate` |
