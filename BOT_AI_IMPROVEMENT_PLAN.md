...
- Этап 5 (Joker logic): начат (MVP `wish/above/takes`, без сложного моделирования ответов)
  ...
  - собран `JOKER regression pack (v1)` в `BOT_AI_TEST_SCENARIOS.md` с классификацией `strict/probe` и retuning-priority (`JOKER-013` как основной probe-таргет; `JOKER-006/011` стабилизированы в strict).
