...
| 7 (Self-play retuning) | protocol активен, итерация #2 = promote candidate | зафиксировать promoted tuned snapshot/коэффициенты и продолжать цикл только при новых целевых гипотезах |
