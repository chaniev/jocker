...

{
  ...
  echo "supported_metrics=winRate,averageScoreDiff,averageUnderbidLoss,averagePremiumAssistLoss,averagePremiumPenaltyTargetLoss"
  echo "pending_stage0_metrics=premiumCaptureRate,blindSuccessRate,jokerWishWinRate,earlyJokerSpendRate,penaltyTargetRate,leftNeighborPremiumAssistRate,bidAccuracyRate,overbidRate"
} > "$metrics_path"
